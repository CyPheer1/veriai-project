...
export function LoginPage() {
  ...
  const handleCreate = async () => {
    ...
    const trimmedPassword = password.trim();
    if (!trimmedEmail || !trimmedPassword) {
      setFormError("Enter an institutional email and password before creating an account.");
      return;
    }
  ...
  return (
    <div className="veriai-academic-bg min-h-screen">
      ...
      <main className="mx-auto max-w-[1360px] px-5 pb-8 pt-8 sm:px-6 lg:px-8">
        <section className="veriai-card-surface grid overflow-hidden rounded-[20px] lg:grid-cols-[0.98fr_1.02fr]">
          <div className="relative min-h-[720px] overflow-hidden bg-[#f8fafc] p-6 sm:p-10">
            ...
            <div className="relative">
              ...
              <h1 className="veriai-display-font mt-10 max-w-[540px] text-[46px] font-semibold leading-[1.02] tracking-[-0.045em] text-[#0d1526] text-balance md:text-[62px]">
                Sign in to continue academic AI review.
              </h1>
              <p className="mt-5 max-w-[560px] text-[17px] leading-8 text-[#40516d]">
              ...
              <div className="mt-12 max-w-[520px] rounded-[14px] border border-[#d7dfed] bg-white/72 p-5 shadow-[0_14px_34px_rgba(39,65,105,0.08)] backdrop-blur">
          ...
          <form onSubmit={handleSubmit} className="bg-white/88 px-6 py-10 sm:px-12 lg:px-16 lg:py-16">
            <p className="text-[12px] font-semibold uppercase tracking-[0.18em] text-[#64748b]">VeriAI access</p>
            <h2 className="veriai-display-font mt-3 text-[40px] font-semibold leading-none tracking-[-0.04em] text-[#0F172A]">Sign in to your account</h2>
            <p className="mt-3 max-w-[48ch] text-[14px] leading-6 text-[#40516d]">
              Use your existing account, or create a free account with the same form.
            </p>
            ...
            <button
              type="submit"
              disabled={isLoading}
              className="veriai-pressable mt-8 h-[56px] w-full rounded-[10px] bg-[#1f5cc4] text-[17px] font-semibold text-white shadow-[0_14px_28px_-18px_rgba(31,92,196,0.95)] hover:bg-[#174ca8] disabled:opacity-60"
            >
            ...
            <button
              ...
              disabled={isLoading}
              className="veriai-pressable mt-3 h-[52px] w-full rounded-[10px] border border-[#cbd7ea] bg-white text-[15px] font-semibold text-[#172033] hover:bg-[#f8fbff] disabled:opacity-60"
            >
              Create free account
            </button>
